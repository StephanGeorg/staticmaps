...
StaticMaps.prototype._drawLine = function () {

  this.lines.forEach(_.bind(function(line){

    var points = line.coords.map(_.bind(function(coord){
      return [
        this._x_to_px(_lon_to_x(coord[0], this.zoom)) * 2,
        this._y_to_px(_lat_to_y(coord[1], this.zoom)) * 2,
      ];
    },this));
