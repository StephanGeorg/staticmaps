...
var StaticMaps = function (options) {
  ...
  this.url_template = this.options.url_template || "https://osm.luftlinie.org/retina/{z}/{x}/{y}.png";
  this.tile_size = this.options.tile_size || 512;
...
StaticMaps.prototype.determineExtent = function (zoom) {
  ...
  // Add bbox to extent
  if (this.center && this.center.length === 4) {
    extents.push(this.center);
  }
